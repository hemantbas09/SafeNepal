...
export class BlogsComponent {
  projectDetails: Array<any> = [
    {
      title:
        'Celebrating World Environment Day 2023: Poem Competition on "Solution to Plastic Pollution"',
      aboutWork:
    ...
    {
      title:
        '"Online Article Writing Competition" and the "Presentation Design Competition"',
      aboutWork:
